          ...
          >
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4 mb-12">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="px-8 py-3 bg-#D4AF37F-300 hover:bg-green-400 text-white font-semibold rounded-full text-lg transition-all shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
              >
                <FaWhatsapp size={20} />
